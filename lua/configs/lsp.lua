...
local ensure_installed = {
  ...
  CMake = { "cmake" },
  Cpp = { "clangd" },
  CSS = { "cssls", "stylelint-language-server", "tailwindcss" },
  Dart = { "dartls" },
  Go = { "gopls", "goimports", "golangci_lint_ls" },
  HTML = { "html", "tailwindcss" },
  Java = { "jdtls", "checkstyle", "google-java-format" },
  JavaScript = { "vtsls", "prettierd", "eslint_d", "eslint", "stylelint-language-server", "tailwindcss" },
  JavaScriptReact = { "vtsls", "prettierd", "eslint_d", "eslint", "stylelint-language-server", "tailwindcss" },
  JSON = { "jsonls" },
  Lua = { "lua_ls", "stylua" },
  Markdown = { "marksman" },
  Python = { "pyright" },
  ...
  TOML = { "taplo" },
  TypeScript = { "vtsls", "prettierd", "eslint_d", "eslint", "angularls", "stylelint-language-server", "tailwindcss" },
  TypeScriptReact = { "vtsls", "prettierd", "eslint_d", "eslint", "stylelint-language-server", "tailwindcss" },
  Vim = { "vimls" },
  Vue = { "volar", "stylelint-language-server", "tailwindcss" },
  XML = { "lemminx" },
  YAML = { "yamlls" },
}
...
local ensure_lang_installed = (function()
  ...
  ---@alias PackageType "lspconfig"|"mason"|"mason-lspconfig"
  ...
  ---@alias PackageDescription LspconfigPackageDescription|MasonPackageDescription
      ...
      local function go()
        ...
        vim.schedule(function()
          install_lang(installing_lang, function()
            installed_langs[installing_lang] = true
            installing_lang = nil
            vim.schedule(go)
          end)
        end)
